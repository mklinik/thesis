...
theorem would hold trivially, not giving rise to the fixpoint semantics in
section \ref{secFixpointSemantics}.
...
\todo{The rest of this section was a dead end. We now use separated sums, and
have to explain what's wrong with coalesced sums. Hint: least fixpoints of
functors are trivial.}
