...
\begin{equation*}
  \forall n \in \bbN \ldotp \varphi(\lub F)(n)\isdefined \implies
  (\lub \varphi(F))(n)\isdefined\ \wedge\ \varphi(\lub F)(n) = (\lub
  \varphi(F))(n)
\end{equation*}
Let $n \in \bbN$. Assume $\varphi(\lub F)(n)\isdefined$.
...
Lub preservation: Let $C = \set{a_n \mid n \in \bbN}$ be a chain in $A$. To prove:
$\varphi(f)(\lub C) = \lub \varphi(f)(C)$. todo continue here
