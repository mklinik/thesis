...
\todo{Move part about polynomial functors to section
\ref{secAlgebraicDataTypeSemantics}, explain there how to go from ADTs to polynomial
functors.}
...
\todo{Say something about Caprettas Partiality is an Effect and the Delay Monad}
