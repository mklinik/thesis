...
semantics for recursive programs, but can also be employed for purely
mathematical goals.
...
Proposition \ref{propFactorialExists} can be rephrased as: the recursively
defined factorial function is well-defined.
...
observe that $\varphi$ is monotone \ldots
