...
\item typed $\lambda$-calculus\onslide<2->{: no fixpoints}
...
sum type & smash sum (y) & separated sum (n) \\
product type & smash product (n) & cartesian product (y)
\end{tabular}
...
\begin{frame}{And The Lazy Natural Numbers?}
